...
import jpa.sessions.ProcesosFacade;
...
@Named("procesosController")
@SessionScoped
public class ProcesosController implements Serializable {

    private Procesos current;
    private DataModel items = null;
    @EJB
    private jpa.sessions.ProcesosFacade ejbFacade;
    ...
    public Procesos getSelected() {
        if (current == null) {
            current = new Procesos();
            selectedItemIndex = -1;
        }
        return current;
    }

    private ProcesosFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Procesos) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("ProcesosCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("ProcesosUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("ProcesosDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
